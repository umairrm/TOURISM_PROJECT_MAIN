...
public class MapsActivityHome extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap map) {
        ...
        LatLng Hunza = new LatLng(36.316223, 74.649877);
        map.addMarker(new MarkerOptions().position(Hunza).title("HUNZA"));
        // [START_EXCLUDE silent]
        map.moveCamera(CameraUpdateFactory.newLatLng(Hunza));
        // [END_EXCLUDE]
        // [START_EXCLUDE]
            ...
            placeResult.addOnCompleteListener (new OnCompleteListener<FindCurrentPlaceResponse>() {
                ...
                public void onComplete(@NonNull Task<FindCurrentPlaceResponse> task) {
                    if (task.isSuccessful() && task.getResult() != null) {
                        ...
                        MapsActivityHome.this.openPlacesDialog();
                    }
                    else {
                        Log.e(TAG, "Exception: %s", task.getException());
                    }
